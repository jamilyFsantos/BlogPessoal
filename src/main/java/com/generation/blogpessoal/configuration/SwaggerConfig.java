...
public class SwaggerConfig {
	...
	@Bean
	public OpenAPI springBlogPessoalpenAPI() {
		 ...
		 return new OpenAPI()
					...
					.contact(new Contact() // Informações de contato / repositório do projeto
						.name("Jamily Fernandes dos Santos")
						.url("https://github.com/jamilyFsantos/BlogPessoal")
						.email("jamilyfernandes71@gmail.com")))
					.externalDocs(new ExternalDocumentation()
						.description("Meu Likedin")
						.url("www.linkedin.com/in/jamilyfernandes"));
		}
